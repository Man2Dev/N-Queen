...
public class Gui {
	...
	static JCheckBoxMenuItem chckbxmntmNewCheckItem;
	static JCheckBoxMenuItem chckbxmntmNewCheckItem_1;
	static JCheckBoxMenuItem chckbxmntmNewCheckItem_2;
	...
	private void initialize() throws InterruptedException {
		...
		menuBar.setBorder(new BevelBorder(BevelBorder.RAISED, Color.BLACK, null, null, null));
//		menuBar.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
//		menuBar.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "Manual use",
//				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(228, 241, 254)));
		// menuBar.setBorder(null);
		// menuBar.setBorderPainted(false);
		// menuBar.setContentAreaFilled(false);
		// menuBar.setFocusPainted(false);
		menuBar.setForeground(Color.BLACK);
		Color color = new Color(127, 143, 166);
		menuBar.setBackground(color);
		frame.setJMenuBar(menuBar);

		Label label_1 = new Label(" Output method:");
		label_1.setEnabled(true);
		label_1.setFont(new Font("Dialog", Font.BOLD, 13));
		menuBar.add(label_1);

		chckbxmntmNewCheckItem = new JCheckBoxMenuItem("images & gif file");
		chckbxmntmNewCheckItem.setBorder(null);
		chckbxmntmNewCheckItem.setContentAreaFilled(false);
		chckbxmntmNewCheckItem.setBorderPainted(false);
		chckbxmntmNewCheckItem.setFocusPainted(false);
		chckbxmntmNewCheckItem.setForeground(Color.BLACK);
		chckbxmntmNewCheckItem.setBackground(color);
		chckbxmntmNewCheckItem.setSelected(false);
		chckbxmntmNewCheckItem.setToolTipText("Print images of all the permutations and a gif of all the permutations."
				+ "(More than 10-Queen is not recommended due to long run time)");
		chckbxmntmNewCheckItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (chckbxmntmNewCheckItem.isSelected() && !chckbxmntmNewCheckItem_1.isSelected()
						&& !chckbxmntmNewCheckItem_2.isSelected()) {
					chckbxmntmNewCheckItem.setSelected(false);
				} else if (!chckbxmntmNewCheckItem.isSelected() && chckbxmntmNewCheckItem_1.isSelected()
						&& !chckbxmntmNewCheckItem_2.isSelected()) {
					chckbxmntmNewCheckItem.setSelected(false);
				} else if (!chckbxmntmNewCheckItem.isSelected() && !chckbxmntmNewCheckItem_1.isSelected()
						&& chckbxmntmNewCheckItem_2.isSelected()) {
		...
		chckbxmntmNewCheckItem_1 = new JCheckBoxMenuItem("text file");
		chckbxmntmNewCheckItem_1.setBorder(null);
		chckbxmntmNewCheckItem_1.setContentAreaFilled(false);
		chckbxmntmNewCheckItem_1.setBorderPainted(false);
		chckbxmntmNewCheckItem_1.setFocusPainted(false);
		chckbxmntmNewCheckItem_1.setForeground(Color.BLACK);
		chckbxmntmNewCheckItem_1.setBackground(color);
		chckbxmntmNewCheckItem_1.setSelected(false);
		chckbxmntmNewCheckItem_1.setToolTipText("Print permutations on text file."
				+ "(More than 13-Queen is not recommended due strange bug that opens text file with UTF-16)");
		...
		chckbxmntmNewCheckItem_2 = new JCheckBoxMenuItem("show in console");
		chckbxmntmNewCheckItem_2.setBorder(null);
		chckbxmntmNewCheckItem_2.setContentAreaFilled(false);
		chckbxmntmNewCheckItem_2.setBorderPainted(false);
		chckbxmntmNewCheckItem_2.setFocusPainted(false);
		chckbxmntmNewCheckItem_2.setForeground(Color.BLACK);
		chckbxmntmNewCheckItem_2.setBackground(color);
		chckbxmntmNewCheckItem_2.setSelected(true);
		chckbxmntmNewCheckItem_2.setToolTipText(
				"Print permutations on console." + "(after 9-Queen all permutations can't fit in console)");
		chckbxmntmNewCheckItem_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (chckbxmntmNewCheckItem.isSelected() && !chckbxmntmNewCheckItem_1.isSelected()
						&& !chckbxmntmNewCheckItem_2.isSelected()) {
					chckbxmntmNewCheckItem_2.setSelected(false);
				} else if (!chckbxmntmNewCheckItem.isSelected() && chckbxmntmNewCheckItem_1.isSelected()
						&& !chckbxmntmNewCheckItem_2.isSelected()) {
					chckbxmntmNewCheckItem_2.setSelected(false);
				} else if (!chckbxmntmNewCheckItem.isSelected() && !chckbxmntmNewCheckItem_1.isSelected()
